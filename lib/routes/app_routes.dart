...
import 'package:subhash_chandra_s_application3/presentation/customization_screen/customization_screen.dart';
...
class AppRoutes {
  ...
  static Map<String, WidgetBuilder> routes = {
    ...
    customizationTwoScreen: (context) => CustomizationScreen(),
  };
}
